...
public class SetupInputWindow{
	...
	public final static String KEY_INSTALLS_JDK = "nexcore.project.installs.jdk";
	public final static String KEY_JDK_TYPE = "nexcore.project.jdk.type";
	public final static String KEY_INSTALLS_ECLIPSE = "nexcore.project.installs.eclipse";
	public final static String KEY_ECLIPSE_TYPE = "nexcore.project.eclipse.type";
	public final static String KEY_J2EE_VERSION = "nexcore.project.j2ee.version";
	public final static String KEY_APPLSERVER_PRODUCT_NAME = "nexcore.project.applserver.product.name";
	public final static String KEY_APPLSERVER_PRODUCT_VERSION = "nexcore.project.applserver.product.version";
	public final static String KEY_UI_PRODUCT_NAME = "nexcore.project.ui.product.name";
	public final static String KEY_SCM_PRODUCT_NAME = "nexcore.project.scm.product.name";
	public final static String KEY_LIBRARY_INCLUDES_CRYPTO = "nexcore.project.library.includes.crypto";
	public final static String KEY_LIBRARY_INCLUDES_DEFERRED = "nexcore.project.library.includes.deferred";
	public final static String KEY_LIBRARY_INCLUDES_XML = "nexcore.project.library.includes.xml";
	...
	protected void saveInput(File f) throws Exception{
		...
		String jdkTp = this.jdkTypeCtrl.getText();
		jdkTp = StringUtils.lowerCase(StringUtils.replace(jdkTp, " ", "_"));

		String eclipseTp = this.eclipseTypeCtrl.getText();
		eclipseTp = StringUtils.lowerCase(StringUtils.replace(eclipseTp, " ", "_"));

		String applSvr = this.applServerProductCtrl.getText();
		String applSvrNm = StringUtils.substringBeforeLast(applSvr, " ");
		applSvrNm = StringUtils.lowerCase(StringUtils.replace(applSvrNm, " ", "_"));
		String applSvrVer = StringUtils.substringAfterLast(applSvr, " ");
		applSvrVer = StringUtils.lowerCase(StringUtils.replace(applSvrVer, " ", "_"));


		String uiPrdNm = this.uiProductCtrl.getText();
		uiPrdNm = StringUtils.lowerCase(StringUtils.replace(uiPrdNm, " ", "_"));

		String scmPrdNm = this.scmProductCtrl.getText();
		scmPrdNm = StringUtils.lowerCase(StringUtils.replace(scmPrdNm, " ", "_"));

		Properties props = new Properties();

		props.setProperty(KEY_PROJECT_CODE, this.projectCodeCtrl.getText());
		props.setProperty(KEY_INSTALLS_JDK, String.valueOf(this.installsJdkCtrl.getSelection()));
		props.setProperty(KEY_JDK_TYPE, jdkTp);
		props.setProperty(KEY_INSTALLS_ECLIPSE, String.valueOf(this.installsEclipseCtrl.getSelection()));
		props.getProperty(KEY_ECLIPSE_TYPE, eclipseTp);
		props.setProperty(KEY_J2EE_VERSION, this.j2eeVersionCtrl.getText());
		props.setProperty(KEY_APPLSERVER_PRODUCT_NAME, applSvrNm);
		props.setProperty(KEY_APPLSERVER_PRODUCT_VERSION, applSvrVer);
		props.setProperty(KEY_UI_PRODUCT_NAME, uiPrdNm);
		props.setProperty(KEY_SCM_PRODUCT_NAME, scmPrdNm);
		props.setProperty(KEY_LIBRARY_INCLUDES_CRYPTO, String.valueOf(this.includesCryptoLibCtrl.getSelection()));
		props.setProperty(KEY_LIBRARY_INCLUDES_DEFERRED, String.valueOf(this.includesDeferredModuleCtrl.getSelection()));
		props.setProperty(KEY_LIBRARY_INCLUDES_XML, String.valueOf(this.includesXmlParserCtrl.getSelection()));
