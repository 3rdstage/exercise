...
<title>Order by Local Service</title>
</head>
<body>
...
OrderLocalServiceHome home = (OrderLocalServiceHome)jndiCtx.lookup("ejb/simple/local/OrderService");
OrderLocalService orderService = home.create();
