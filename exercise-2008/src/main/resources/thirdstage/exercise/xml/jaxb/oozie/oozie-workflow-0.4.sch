<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"
	xmlns:workflow="uri:oozie:workflow:0.4" elementFormDefault="qualified"
	...
	<xs:complexType name="WORKFLOW-APP">
		<xs:sequence>
			...
			<xs:element name="global" type="workflow:GLOBAL"
				minOccurs="0" maxOccurs="1" />
	...
	<xs:complexType name="STREAMING">
		<xs:sequence>
			...
			<xs:element name="reducer" type="xs:string" minOccurs="0"
				maxOccurs="1" />
			<xs:element name="record-reader" type="xs:string"
				minOccurs="0" maxOccurs="1" />
