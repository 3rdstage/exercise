...
public class ComponentMetaRegistryTest {
	...
	public static void main(String[] args) throws Exception{
		...
		ApplicationContext springCtx = new ClassPathXmlApplicationContext("thirdstage/exercise/jmx/spring/case3/spring.xml");
		
		ComponentMetaRegistryImpl registry = (ComponentMetaRegistryImpl)springCtx.getBean("componentRegistry");
