 ...
 * 
 */
package thirdstage.common1.entities.test.mysql;
...
public class BaseTest {
	...
	public static void setUpBeforeClassBase() throws Exception {
		...
		springContext = new ClassPathXmlApplicationContext("thirdstage/common1/confs/spring-common.mysql.xml");
	...
	protected void cleanAndLoadTestData(File testDataSetFile) throws Exception{
		IDatabaseConnection conn = new MySqlConnection(((DataSource)springContext.getBean("dataSource")).getConnection(), "test2");
