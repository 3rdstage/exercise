...
<div align='left'><a name='pageTop'/>
	    ...
	    <table border='0' cellspacing='0' cellpadding='0'>
	       <tr>
		  <td class='title'><h:outputText value='#{bundle["title.roleManagement"]}' rendered='true' /></td>
	       </tr>
	    </table>
		
	    <br><br>    

<h:dataTable id='roleList' value='#{roleManagementPageHelper.allRoles}' var='role' 
             border='0' width='460' cellspacing='1' cellpadding='2'>
<h:column>
...
<h:column>
	<f:facet name='header'><h:outputText value='#{bundle["field.description"]}'/></f:facet>
