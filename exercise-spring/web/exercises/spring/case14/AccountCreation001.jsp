...
<spring:hasBindErrors name="createAccount">
<ul>
	<c:forEach items="${errors.allErros}" var="error">
...
<tr>
	<td><label for="${status.expression}" <c:if test="${status.error}">class="error"</c:if>>Username : </label></td>
	<td>
		<input type="text" id="${status.experssion}" name="${status.expression}" value="${status.value}"/>
	</td>
</tr>	
</spring:bind>
...
<tr>
	<td><label for="${status.expression}" <c:if test="${status.error}">class="error"</c:if>>Password : </label></td>
	<td>
		<input type="password" id="${status.experssion}" name="${status.expression}" value="${status.value}"/>
	</td>
</tr>
</spring:bind>
</spring:nestedPath>
...
<tr>
	<td><label for="${status.expression}" <c:if test="${status.error}">class="error"</c:if>>Confirm Password : </label></td>
	<td>
		<input type="password" id="${status.experssion}" name="${status.expression}" value="${status.value}"/>
	</td>
</tr>
...
<tr>
	<td><label for="${status.expression}" <c:if test="${status.error}">class="error"</c:if>>Email : </label></td>
	<td>
		<input type="text" id="${status.experssion}" name="${status.expression}" value="${status.value}"/>
	</td>
</tr>
