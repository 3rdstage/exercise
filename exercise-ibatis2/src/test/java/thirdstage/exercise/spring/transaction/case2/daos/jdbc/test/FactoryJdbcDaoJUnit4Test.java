 ...
 * 
 */
public class FactoryJdbcDaoJUnit4Test extends FactoryDaoJUnit4Test{

	private static ApplicationContext applContext;
	private static IDataSet dataSet;
	private FactoryJdbcDao factoryDao;
	...
	public void setUp() throws Exception{
		factoryDao = new FactoryJdbcDao();
		factoryDao.setDataSource((DataSource)(this.applContext.getBean("dataSource")));
	}
