 ...
 *
 */
public class CompanyIBatisDaoJUnit4Test extends CompanyDaoJUnit4Test{
	
	protected static ApplicationContext applContext;
	protected static IDataSet dataSet;
	protected CompanyIBatisDao companyDao;
	...
	public void setUp() throws Exception{
		companyDao = new CompanyIBatisDao();
		companyDao.setSqlMapClient((SqlMapClient)(this.applContext.getBean("sqlMapClient")));
	}
