...
@date 2008-07-03
@description
	Comments out some rows to be used as seed data of DbUnit 

@version 1.2
@author Sang-Moon Oh
@date 2008-06-23
@description 
	Add trucate table statements to remove current data before insert statements
	 
@version 1.1
@author Sang-Moon Oh
@date 2008-06-13
@description 
	Change the order of statements and names of objects according to schema enhancement
*/
﻿use petstore1d;
